                    ...
                    <div class="footer_widget">
                        ...
                        <div class="copyright_text">
                            ...
                            <p style="margin-top: 10px; font-size: 13px; color: #64748b;">
                                Designed & Managed by 
                                <a href="https://zayacodehub.in" target="_blank" style="color: #6a4fdb; font-weight: 700; text-decoration: none; border-bottom: 2px solid rgba(106,79,219,0.3); padding-bottom: 2px; transition: all 0.3s ease;">
                                    ZAYA CODE HUB
                                </a>
                            </p>
                        </div>
