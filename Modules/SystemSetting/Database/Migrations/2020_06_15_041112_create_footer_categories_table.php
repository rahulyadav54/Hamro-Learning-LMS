...
class CreateFooterCategoriesTable extends Migration
{
    ...
    public function up()
    {
        ...
        FooterCategory::create([
            ...
            'description' => '<p>@SONALMS - Ultimate Learning Management All Rights Reserved to - <a href="https://codecanyon.net/user/codethemes/portfolio" rel="noopener noreferrer" target="_blank" style="color: rgb(254, 23, 36);">CodeThemes</a></p>',
        ]);
