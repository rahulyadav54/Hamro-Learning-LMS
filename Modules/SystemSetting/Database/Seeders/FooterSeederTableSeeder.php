...
class FooterSeederTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        FooterCategory::create([
            ...
            'description' => '<p>Copyright © 2020 All rights reserved | This SONALMS Application is made by <a href="https://codecanyon.net/user/codethemes/portfolio" rel="noopener noreferrer" target="_blank">Codethemes</a></p>',
        ]);
