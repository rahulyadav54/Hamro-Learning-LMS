...
class CreateGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('general_settings', function (Blueprint $table) {
            $table->id();
            $table->string('site_title')->nullable()->default('SONA LEARN');
            ...
            $table->string('copyright_text')->default('Copyright © 2021 SONALMS. All rights reserved');
        ...
        DB::table('general_settings')->insert([
            [
                ...
                'zip_code' => '1205',
                'active_status' => '1',
                'copyright_text' => 'Copyright © 2021 SONALMS. All rights reserved | Made By CodeThemes ',
                'footer_copy_right' => 'Copyright © 2021 SONALMS. All rights reserved | Made By  <a href="https://spondonit.com" target="_blank"><span style="color:#D12053">CodeThemes</span></a>',
