...
Route::group(['namespace' => 'Instructor', 'prefix' => 'instructor', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/materials', 'MaterialController@index')->name('instructor.materials.index');
    Route::get('/materials/create', 'MaterialController@create')->name('instructor.materials.create');
    Route::post('/materials/store', 'MaterialController@store')->name('instructor.materials.store');
    Route::get('/materials/edit/{id}', 'MaterialController@edit')->name('instructor.materials.edit');
    Route::post('/materials/update/{id}', 'MaterialController@update')->name('instructor.materials.update');
    Route::get('/materials/delete/{id}', 'MaterialController@destroy')->name('instructor.materials.delete');
    Route::get('/materials/download/{id}', 'MaterialController@download')->name('instructor.materials.download');
    ...
    Route::get('/assignments/edit/{id}', 'AssignmentController@edit')->name('assignments.edit');
    Route::post('/assignments/update/{id}', 'AssignmentController@update')->name('assignments.update');
    Route::get('/assignments/delete/{id}', 'AssignmentController@destroy')->name('assignments.delete');
    Route::get('/assignments/{id}/submissions', 'AssignmentController@submissions')->name('assignments.submissions');
    Route::post('/submissions/grade/{id}', 'AssignmentController@grade')->name('submissions.grade');

    // ===== Instructor Live Classes =====
    Route::get('/live-classes', 'LiveClassController@index')->name('instructor.live-classes.index');
    Route::get('/live-classes/create', 'LiveClassController@create')->name('instructor.live-classes.create');
    Route::post('/live-classes/store', 'LiveClassController@store')->name('instructor.live-classes.store');

    // ===== Instructor Calendar =====
    Route::get('/calendar-events', 'CalendarController@index')->name('calendar.index');
    Route::get('/calendar-events/feed', 'CalendarController@feed')->name('calendar.feed');
    Route::post('/calendar-events/store', 'CalendarController@store')->name('calendar.store');
    Route::post('/calendar-events/delete/{id}', 'CalendarController@destroy')->name('calendar.delete');

    // ===== Instructor AI Assistant =====
    Route::get('/ai-assistant', 'AiController@index')->name('instructor.ai.index');
    Route::post('/ai-assistant/generate', 'AiController@generate')->name('instructor.ai.generate');
    Route::post('/ai-assistant/generate-questions', 'AiController@generateQuestions')->name('instructor.ai.generate_questions');

    // ===== Instructor Reports =====
    Route::get('/reports/revenue-analytics', 'ReportController@revenue')->name('instructor.reports.revenue');
    Route::get('/reports/student-analytics', 'ReportController@student')->name('instructor.reports.student');

    // Wildcard catch-all routes must be at the very bottom
