...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user->email = 'teacher@sona.com';
        $user->username = 'teacher@sona.com';
        ...
        $user->role_id = 3;
        $user->name = 'Student';
        $user->email = 'student@sona.com';
        $user->username = 'student@sona.com';
